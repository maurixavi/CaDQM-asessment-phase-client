...
export class DqMeasurementResultsComponent implements OnInit {
  ...
  fetchMethodExecutionResult1504(methodId: number): void {
    if (!this.dqModelVersionId) return;
  ...
  private processSingleResult_154(result: any): void {
  ...
  private processMultipleResults_0(result: any): void {
  ...
  private processMultipleResults_154(result: any): void {
    if (this.selectedMethodDetail) {
